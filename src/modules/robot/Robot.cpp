...
void Robot::on_config_reload(void *argument)
{
    ...
    this->delta_stepper_motor  = new StepperMotor(delta_step_pin, delta_dir_pin, delta_en_pin);
    ...
    delta_stepper_motor->set_max_rate(THEKERNEL->config->value(delta_max_rate_checksum)->by_default(30000.0F)->as_number() / 60.0F);
